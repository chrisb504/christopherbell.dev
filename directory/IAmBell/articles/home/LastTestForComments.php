...
<html>
    ...
    <body>
		...
		Post Added. <h1 style="font-size: 70px; text-align:center;">LastTestForComments</h1><div class= "article">
			            <div class="panel panel-primary">
			                <div class="panel-heading">163</div>
			      <div class="panel-body">This truly may be the last test for comments</div>
					<div class="panel-footer">Azurras</div>
			            </div>     
			            <h2>Comments</h2>
